      ...
      <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <div>
          <div className="space-y-5 text-lg leading-relaxed text-text-secondary">
            {[
            'I am Ilma Niyas, an Information Technology graduate from Rajarata University of Sri Lanka, with a deep passion for the intersection of business strategy and technology.',
          ...
          <motion.div
            ...
            <p className="text-base leading-relaxed text-text-secondary">
              Seeking internship and graduate opportunities in Business
